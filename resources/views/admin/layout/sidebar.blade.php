                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{URL::to('/home/index')}}">Dashboard</a></li>
                    ...
                    <li><a><i class="fa fa-edit"></i> Manage Article <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{URL::to('/notes/create')}}">Create Notes</a></li>
                            <li><a href="{{URL::to('/notes')}}">Manage Notes</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-edit"></i> Manage Users <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="form.html">Create users</a></li>
                            <li><a href="form_advanced.html">List users</a></li>
                        </ul>
                    </li>
